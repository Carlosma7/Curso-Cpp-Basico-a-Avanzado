...
// Enter a number from 1 to 12 and show the name of the corresponding month
...
int main(){
    ...
    switch(mes){
        ...
        case 12: cout << "Dicember" << endl;   break;
        default: cout << "[Error] Not a valid month" << endl;	break;
    }
